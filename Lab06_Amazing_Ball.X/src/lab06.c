...
// define circle center, radius and angular velocity
#define center_x 409
#define center_y 310
#define radius 200
...
// Boolean flags, or truth flag, which encodes
// a state variable with two possible values.
...
// Use a counter to simulate time changes for sin(w*t) function
float t = 0.01;
...
void initialize_timer()
{
    ...
    // Timer 1 (10 ms) used for Interrupts
    ...
    // Timer 2 (50 ms) only used for pwm
